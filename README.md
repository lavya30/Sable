...
> 💡 **Why does this happen?** Code signing certificates cost $200–600/year. As an independent open-source project, Sable is not commercially signed. This warning appears for _any_ unsigned application and is not an indication of malware. If you prefer, you can always [build from source](#build-from-source) instead.
