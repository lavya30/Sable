    ...
    content: {
      ...
      content: [
        ...
        },
        {
          type: 'heading',
          attrs: { level: 2 },
          content: [{ type: 'text', text: 'What I did today' }],
        },
      ...
      content: [
        {
          type: 'heading',
          attrs: { level: 1 },
          content: [{ type: 'text', text: 'Title of the Essay' }],
        },
        {
          type: 'paragraph',
        ...
        { type: 'paragraph', content: [{ type: 'text', text: '...' }] },
        {
          type: 'heading',
          attrs: { level: 2 },
          content: [{ type: 'text', text: 'Argument 2' }],
        },
        { type: 'paragraph', content: [{ type: 'text', text: '...' }] },
        {
          type: 'heading',
      ...
      content: [
        ...
        },
        {
          ...
          content: [
            {
              type: 'paragraph',
              content: [{ type: 'text', text: 'A brief logline or premise.' }],
            },
          ],
        },
        {
