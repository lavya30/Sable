    ...
    <>
      ...
      >
        <div className="w-16 h-16 rounded-full bg-mint dark:bg-emerald-600 flex items-center justify-center border-2 border-ink dark:border-slate-200 shadow-hard group-hover:shadow-hard-hover group-hover:-translate-y-1 transition-all">
          <span className="material-symbols-outlined text-4xl text-ink dark:text-slate-100">
            add
          </span>
        </div>
        <h3 className="font-heading text-xl mt-4 text-ink dark:text-slate-100">
          New Notebook
        </h3>
        <p className="font-marker text-gray-700 dark:text-gray-300">
          Start fresh
        </p>
      </div>
            ...
            <div className="bg-white dark:bg-slate-800 border-2 border-ink dark:border-slate-600 rounded-notebook shadow-hard-lg w-full max-w-3xl mx-4 overflow-hidden animate-[slide-down_0.2s_ease]">
              ...
              <div className="bg-mint dark:bg-emerald-600 border-b-2 border-ink dark:border-slate-600 px-6 py-4 flex items-center justify-between">
                <div>
                  ...
                  <p className="font-marker text-sm text-gray-900 -rotate-1 inline-block">
                    Every great story starts with a title
                  </p>
                </div>
                <button
                ...
                >
                  <span className="material-symbols-outlined text-lg text-ink dark:text-slate-100">
                    close
                  </span>
                </button>
              </div>
              ...
              <div className="px-6 py-6 flex flex-col md:flex-row gap-8">
                ...
                <div className="flex-1 flex flex-col gap-5">
                  <div className="flex flex-col gap-1.5">
                    <label className="text-sm font-display font-bold text-ink dark:text-slate-200">
                      Name
                    </label>
                    <input
                      ref={inputRef}
                ...
                <div className="flex-1 flex flex-col gap-1.5 border-t-2 md:border-t-0 md:border-l-2 border-ink/10 dark:border-slate-700 pt-5 md:pt-0 md:pl-8">
                  ...
                  <div
                    className="flex flex-col gap-2 max-h-[320px] overflow-y-auto pr-2 custom-scrollbar"
                    data-lenis-prevent
                  >
                    {TEMPLATES.map((t) => (
                      <button
                      ...
                      >
                        ...
                        <div className="flex-1 mt-0.5">
                          <p className="text-sm font-bold text-ink dark:text-slate-100 leading-tight mb-1">
                            {t.name}
                          </p>
                          <p className="text-[11px] font-body text-ink/60 dark:text-slate-400 leading-snug">
                            {t.description}
                          </p>
                        </div>
                      </button>
